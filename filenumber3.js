...
console.log("4 to the 2nd power is: "); //16
console.log(4 ** 2);

console.log("The remainder when 25 is divided by 4 is: "); //1
console.log(25 % 4);

console.log("13 + 8 / 2 - 1 = ");
console.log(13 + 8 / 2 - 1); //What will this equal? Remember Order of Operations!-16

console.log("(13 + 8) / (2 - 1) = ");
console.log((13 + 8) / (2 - 1)); //What will this equal? Is it the same as the previous line? 21
